...
exports.forceReRender = exports.configure = exports.raw = exports.getStorybook = exports.clearDecorators = exports.addParameters = exports.addDecorator = exports.setAddon = exports.storiesOf = exports.WRAPS = void 0;
  ...
  return decorators.reduce(function (decorated, decorator) {
    return function () {
      ...
      var decoratedStory = decorator(function () {
        ...
        story = decorated(Object.assign(context, p, {
